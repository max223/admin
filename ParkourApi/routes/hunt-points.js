...
const { hunt_points } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('hunt_points');

// This file contains the logic of every route in Forest Admin for the collection hunt_points:
...
// Create a Hunt Point
router.post('/hunt_points', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Hunt Point
router.put('/hunt_points/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Hunt Point
router.delete('/hunt_points/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Hunt Points
router.get('/hunt_points', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Hunt Points
router.get('/hunt_points/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Hunt Point
router.get('/hunt_points/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Hunt Points
router.get('/hunt_points.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
